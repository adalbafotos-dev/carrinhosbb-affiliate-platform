...
const DEFAULT_SILO_GROUP_DEFINITIONS: readonly SiloGroupDefinition[] = [
  {
    ...
    label: "Preco / oportunidade",
    keywords: ["preco", "barato", "economico", "oferta", "promocao", "custo", "beneficio"],
    menu_order: 10,
  },
  {
    key: "decisao_escolha",
    label: "Decisao / escolha",
    keywords: ["melhor", "escolher", "guia", "comparativo", "qual", "vale a pena"],
    menu_order: 20,
  },
  {
    key: "tipos",
    label: "Tipos",
    keywords: ["tipos", "modelo", "berco", "passeio", "guarda-chuva", "travel system"],
    menu_order: 30,
  },
  {
    key: "viagem_portabilidade",
    label: "Portabilidade / viagem",
    keywords: ["viagem", "portatil", "portabilidade", "dobravel", "aviao", "mala"],
    menu_order: 40,
  },
  {
    key: "peso_capacidade",
    label: "Peso / capacidade",
    keywords: ["peso", "capacidade", "kg", "suporte", "limite"],
    menu_order: 50,
  },
  {
    key: "fase_idade",
    label: "Fase / idade",
    keywords: ["idade", "fase", "meses", "anos", "recem nascido", "crianca"],
    menu_order: 60,
  },
  {
    key: "recursos",
    label: "Recursos",
    keywords: ["recurso", "funcao", "acessorio", "conforto", "seguranca", "ajuste"],
    menu_order: 70,
  },
] as const;
