        ...
        <div className="space-y-3">
          <div className="rounded border border-[color:var(--border)] bg-[color:var(--surface)] p-2 text-[10px] text-[color:var(--muted)]">
            <div className="flex items-center justify-between text-[11px] font-semibold text-[color:var(--text)]">
              ...
              <span className="text-[10px] text-[color:var(--muted)]">{intentStats.serpIntent}</span>
            </div>
            <div className="mt-2 grid grid-cols-3 gap-2">
              <div className="rounded border border-[color:var(--border)] bg-[color:var(--surface-muted)] p-2 text-center">
                <div className="text-[11px] font-semibold text-[color:var(--text)]">{intentStats.ecommerceCount}</div>
                <div>comercial</div>
              </div>
              <div className="rounded border border-[color:var(--border)] bg-[color:var(--surface-muted)] p-2 text-center">
                <div className="text-[11px] font-semibold text-[color:var(--text)]">{intentStats.informationalCount}</div>
                <div>informacional</div>
              </div>
              <div className="rounded border border-[color:var(--border)] bg-[color:var(--surface-muted)] p-2 text-center">
                <div className="text-[11px] font-semibold text-[color:var(--text)]">{intentStats.comparativeCount}</div>
                <div>comparativo</div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded border border-[color:var(--border)] bg-[color:var(--surface)] p-2">
            <div className="text-[11px] font-semibold text-[color:var(--text)]">Dominios dominantes</div>
            {domainStats.length === 0 ? (
              <p className="mt-2 text-[10px] text-[color:var(--muted-2)]">Sem dominios suficientes.</p>
            ) : (
