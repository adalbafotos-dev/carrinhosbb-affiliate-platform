...
const IconBlockView = ({ node, updateAttributes, selected }: any) => {
  ...
  const title = String(attrs.title || "Lista com Icones");
      ...
      <div className="rounded-xl border border-(--border) bg-(--surface) p-4 shadow-sm">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs uppercase text-(--muted-2)">Icones</p>
        ...
        <div className="mb-3 flex flex-wrap items-center gap-2 text-[11px] text-(--muted)">
          <button
            ...
            onClick={() => {
              const next = window.prompt("Titulo do bloco", title);
          ...
          <div className="flex items-center gap-2 rounded border border-(--border) px-2 py-1">
            <span className="text-[10px] uppercase tracking-wide text-(--muted-2)">Visivel</span>
...
export const IconBlock = Node.create({
  ...
  addAttributes() {
    return {
      title: {
        default: "Lista com Icones",
        parseHTML: (element) => element.getAttribute("data-title") || "Lista com Icones",
      },
      items: {
        default: [],
  ...
  renderHTML({ HTMLAttributes }) {
    ...
    return [
      ...
      [
        ...
        ["p", { class: "icon-block__title" }, withResponsive.title || "Lista com Icones"],
        [
          "ul",
