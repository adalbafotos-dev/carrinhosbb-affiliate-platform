            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden">
                    ...
                    <div>
                        ...
                        <div className="relative flex items-center">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="absolute right-2 text-zinc-400 hover:text-orange-500 transition-colors"
                ...
                <div className="px-6 py-4 bg-zinc-50 border-t border-zinc-100 flex justify-end gap-2">
                    ...
                    <button
                        ...
                        className="px-6 py-2 text-sm bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-bold shadow-sm"
                    >
