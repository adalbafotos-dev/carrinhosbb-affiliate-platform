    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center bg-black/60 backdrop-blur-sm p-4 pt-32">
      <div className="w-full max-w-md rounded-xl bg-white shadow-2xl">
        ...
        <div className="space-y-4 p-6">
          ...
          <div>
            <label className="text-xs font-bold uppercase text-zinc-500">Texto do botao</label>
            <input
              className="mt-2 w-full rounded border border-zinc-200 p-2 text-sm"
              value={label}
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              <label className="text-xs font-bold uppercase text-zinc-500">Cor do botao</label>
              <input
                type="color"
