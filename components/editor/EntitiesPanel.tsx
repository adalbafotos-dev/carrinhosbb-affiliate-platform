        ...
        <section className="space-y-3 rounded-lg border border-(--border) bg-(--surface-muted) p-3">
            ...
            <div className="flex gap-1">
                <input
                    ...
                    className="flex-1 px-2 py-1.5 text-[11px] rounded-md border border-(--border) bg-(--surface) text-(--text) outline-none placeholder:text-(--muted-2)"
                />
                <button
                        ...
                        <div className="flex flex-wrap gap-1">
                            ...
                            {entity.marked && (
                                <button
                                    ...
                                    className="ml-auto px-1.5 py-0.5 text-[9px] rounded border border-red-300 bg-red-50 text-red-700 hover:bg-red-100 dark:border-red-700 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-900/50"
                                >
                                    Desmarcar
                                </button>
                            )}
